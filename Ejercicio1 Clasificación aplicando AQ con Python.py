...
for atributo in atributos:
    ...
    # Comparar y guardar los valores que están
    # en positivos pero no en negativos
    ...
    # Si hay valores válidos, agregarlos a la regla
...
print("\nRegla inducida para identificar si un nuevo cliente")
print("comprará un automóvil eléctrico:")
...
# Paso 5: Mostrar la regla en formato SI - ENTONCES
